 ...
 * listener at module-load (imported for side-effect in the root providers) and stash the event so a
 * button mounted later can still offer "Install". Components subscribe to be notified when the event
 * arrives or the app gets installed.
 */
