 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- generic default for arbitrary row data
...
export interface ContextMenuState {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- tanstack column of unknown row shape
  column: any | null
  isVisible: boolean
