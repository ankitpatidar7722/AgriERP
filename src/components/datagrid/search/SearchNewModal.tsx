...
interface SearchNewModalProps<TData> {
  data: TData[]
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- column defs of arbitrary shape
  columns: any[]
  mainColumns?: string
...
export function SearchNewModal<TData>({
  ...
  const getRowDisplayText = useCallback((row: TData) => {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- reading arbitrary display fields off a row of unknown shape
